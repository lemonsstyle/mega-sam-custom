...
if __name__ == "__main__":
  ...
  parser.add_argument("--recon_dir", type=str, default="reconstructions", help="reconstruction directory")
  parser.add_argument("--cache_dir", type=str, default="./cache_flow", help="cache directory for flow")
  args = parser.parse_args()

  cache_dir = args.cache_dir
  rootdir = args.recon_dir
